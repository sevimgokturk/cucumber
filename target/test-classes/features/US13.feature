...
Feature:doctor_can_see_test-result
  Background: TC01_02_before
    ...
    And   Doctor clicks on one of the Edit button

  @US13_TC01
  Scenario: TC01
    Then  Doctor clicks on the Show Test Result button.
    ...
    And   Doctor verifies that  all test result elements  are displayed.
